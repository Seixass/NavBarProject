  ...
  const handleItemClick = (itemName) => {
    ...
    <NavbarContainer>
      <NavMenu>
        ...
        <NavItem>
          <NavLink href="Graficos" isActive={setActiveItem === 'Graficos'} onClick={() => handleItemClick('Graficos')}>
            <NavIcon src={graficos} alt="Graficos" />
          </NavLink>
        </NavItem>
        <NavItem>
          <NavLink href="/Home" isActive={setActiveItem === 'Home'} onClick={() => handleItemClick('Home')}>
            <NavIcon src={home} alt="Home" />
          </NavLink>
        </NavItem>
        <NavItem>
          <NavLink href="Agendamento" isActive={setActiveItem === 'Agendamento'} onClick={() => handleItemClick('Agendamento')}>
            <NavIcon src={agendamento} alt="Agendamento" />
          </NavLink>
        </NavItem>
        <NavItem>
          <NavLink href="RelatoriosDiario" isActive={setActiveItem === 'RelatoriosDiario'} onClick={() => handleItemClick('RelatoriosDiario')}>
